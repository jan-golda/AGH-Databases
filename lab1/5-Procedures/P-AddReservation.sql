-- procedurre
create or replace procedure P_ADD_RESERVATION (v_trip_id in number, v_person_id in number) as
  v_id_count number;
begin
  ...
  -- create reservation
  insert into RESERVATIONS (TRIP_ID, PERSON_ID, STATUS) VALUES (v_trip_id, v_person_id, 'N');
