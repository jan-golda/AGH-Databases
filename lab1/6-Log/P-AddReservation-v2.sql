-- procedurre
create or replace procedure P_ADD_RESERVATION_2 (v_trip_id in number, v_person_id in number) as
  v_id_count number;
...
begin
  ...
  insert into RESERVATIONS_LOG (RESERVATION_ID, STATUS) values (v_reservation_id, 'N');


end P_ADD_RESERVATION_2;
